...
export const Toast: React.FC<ToastProps> = ({ message, type, onClose }) => {
  ...
  return (
    <div
      className="fixed bottom-24 left-1/2 transform -translate-x-1/2 w-auto z-[9999] transition-all duration-300 ease-in-out"
      onMouseEnter={onClose} // Close on hover (optional, or stick to onHoverEnd equivalent)
    >
