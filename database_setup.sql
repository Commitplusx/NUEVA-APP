...
ON public.restaurants
FOR ALL
USING (true); -- En producción, cambiar por una verificación de rol
...
CREATE POLICY "Allow admin full access for menu_items" ON public.menu_items FOR ALL USING (true); -- En producción, cambiar por una verificación de rol
...
VALUES
(1, 'Rose Garden Restaurant', 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=2070&auto=format&fit=crop', 4.7, 'Free', '20 min'),
(4, 'Burger Joint', 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?q=80&w=1998&auto=format&fit=crop', 4.8, '$20', '25 min')
